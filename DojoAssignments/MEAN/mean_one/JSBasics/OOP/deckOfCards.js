...
class Player {
    ...
    draw(deck){
        this.hand.push(deck.deal_random());
        return this;
    }
    discard(card){
        this.hand.length--;
...
nicci.newDeck();
ray.newDeck();
// console.log(nicci.deal_random().deal_random().deal_random());
// console.log(ray.shuffle());

var shannon = new Player(shannon);
console.log(shannon);
console.log(shannon.draw(nicci).draw(nicci).draw(ray));